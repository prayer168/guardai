...
export const knowledgeItems: KnowledgeItem[] = [
  {
    ...
    category: "假客服",
    title: "解除分期與重複扣款",
    cue: "要求保持通話、操作 ATM／網銀，或提供驗證碼。",
    verify: "掛斷後，從訂單頁或發卡銀行卡片背面的官方電話查證。",
    source: "165 全民防騙網",
    sourceUrl: "https://165.npa.gov.tw/",
    updated: "2026-07-18",
  },
  {
    id: "investment",
    category: "假投資",
    title: "保證獲利與群組帶單",
    cue: "穩賺不賠、名額有限、先繳保證金、禁止告訴親友。",
    verify: "查詢合法業者資格；不要使用群組內提供的客服與出金管道。",
    source: "165 全民防騙網",
    sourceUrl: "https://165.npa.gov.tw/",
    updated: "2026-07-18",
  },
  {
    ...
    category: "網購包裹",
    title: "小額補款釣信用卡",
    cue: "用 10–50 元的小額費用降低戒心，再要求信用卡或 OTP。",
    verify: "直接開購物平台或物流官方 App 查訂單，不點簡訊連結。",
    source: "165 詐騙闢謠開放資料",
    sourceUrl: "https://data.gov.tw/dataset/38262",
    updated: "2026-07-14",
  },
  {
    id: "family",
    category: "冒名親友",
    title: "換號碼與緊急借款",
    cue: "新號碼、急需匯款、拒絕通話，或要求不要告訴其他家人。",
    verify: "使用原本保存的電話回撥，並詢問不涉及敏感資料的共同經歷。",
    source: "165 全民防騙網",
    sourceUrl: "https://165.npa.gov.tw/",
    updated: "2026-07-18",
  },
  {
    ...
    category: "釣魚連結",
    title: "停權、補繳與限時驗證",
    cue: "縮短網址、仿冒網域、倒數時間與重新登入要求。",
    verify: "不從訊息進入；手動開啟官方 App 或自己輸入已知官方網址。",
    source: "165 詐騙闢謠開放資料",
    sourceUrl: "https://data.gov.tw/dataset/38262",
    updated: "2026-07-14",
  },
  {
    ...
    category: "帳號盜用",
    title: "索取 OTP 與遠端協助",
    cue: "任何人索取一次性驗證碼、備援碼、密碼或要求共享畫面。",
    verify: "OTP 只輸入在自己確認的官方服務內；開啟雙重驗證並檢查登入紀錄。",
    source: "165 全民防騙網",
    sourceUrl: "https://165.npa.gov.tw/",
    updated: "2026-07-18",
  },
